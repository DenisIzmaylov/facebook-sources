/*!CK:3901901358!*//*1401163336,178171423*/
...
__d("Live", ["Arbiter", "AsyncDOM", "AsyncSignal", "ChannelConstants", "DataStore", "DOM", "ServerJS", "createArrayFrom", "emptyFunction"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    ...
    var q = {logAll: false, startup: function (r) {
        q.logAll = r;
        q.startup = o;
        ...
        if (q.logAll) {
            ...
            new i('/common/scribe_endpoint.php', {c: 'live_sequence', m: r}).send();
        }
    }};
    e.exports = q;
}, null);
        ...
        g.loadModules(["DOM", "collectDataAttributes"], function (k, l) {
            j.forEach(function (m) {
                ...
                if (Object.keys(o).length) {
                    var p = k.create('input', {type: 'hidden', name: 'link_data', value: JSON.stringify(o)});
                    n.appendChild(p);
                }
            });
        });
