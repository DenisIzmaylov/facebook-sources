...
__d("CLoggerX", ["Banzai", "DOM", "debounce", "Event", "ge", "Parent", "Keys"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = 10 * 60 * 1000, n = b('Keys').RETURN, o = {}, p = function (s) {
        ...
        if (!v)return;
        if (u > 5 && !v.submitted) {
            g.post('censorlogger', {cl_impid: v.impid, clearcounter: v.clearcounter, instrument: v.type, elementid: t, parent_fbid: (v.parent_fbid == 'unknown' ? null : v.parent_fbid), version: "x"}, g.VITAL);
        ...
        this.feedbackForms[s] = {parent_fbid: v, parent_type: w};
        ...
        this.trackedElements[x] = {submitted: false, clearcounter: 0, type: t, impid: this.impressionID, parent_fbid: u, parent_type: v, parentElID: y};
        ...
        if (!v)h.prependContent(s, h.create('input', {type: 'hidden', name: 'clp', value: this.getJSONRepForTrackerID(t)}));
        ...
        if (!u)return "";
        return JSON.stringify({cl_impid: u.impid, clearcounter: u.clearcounter, elementid: s, version: "x", parent_fbid: t || u.parent_fbid});
    }}, r = function (s) {
        return i(function () {
...
__d("LiveTimer", ["CSS", "DOM", "ServerTime", "fbt", "tx"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = 1000, m = 60, n = 3600, o = 43200, p = 86400, q = 60, r = 20000, s = {restart: function (t) {
        i.update(t * 1000);
        ...
        this.timestamps && this.timestamps.forEach(function (x) {
            ...
            if (aa.text)h.setContent(x, aa.text);
            if (aa.next != -1 && (aa.next < v || v == -1))v = aa.next;
        }.bind(this));
        if (v != -1) {
        ...
        if (z < 1) {
            if (v && y == 1) {
                ...
                w.text = j._("{number} \u043c\u0438\u043d.", [j.param("number", y)]);
            } else w.text = y == 1 ? "\u043e\u043a\u043e\u043b\u043e \u043c\u0438\u043d\u0443\u0442\u044b \u043d\u0430\u0437\u0430\u0434" : k._("{number} \u043c\u0438\u043d. \u043d\u0430\u0437\u0430\u0434", {number: y});
            w.next = m - x % m;
            return w;
        }
        if (z < 11)w.next = n - x % n;
        if (v && z == 1) {
            w.text = "1 \u0447.";
        } else if (v) {
            w.text = j._("{number} \u0447.", [j.param("number", z)]);
        } else w.text = z == 1 ? "\u043e\u043a\u043e\u043b\u043e \u0447\u0430\u0441\u0430 \u043d\u0430\u0437\u0430\u0434" : k._("{number} \u0447. \u043d\u0430\u0437\u0430\u0434", {number: z});
        return w;
    }, renderRelativeTimeToServer: function (t, u) {
        return this.renderRelativeTime(Math.floor(i.get() / l), t, u);
    }};
    e.exports = s;
    e.exports.CONSTS = {MS_IN_SEC: l, SEC_IN_MIN: m, SEC_IN_HOUR: n, SEC_IN_12_HOUR: o, SEC_IN_24_HOUR: p, MIN_IN_HOUR: q, HEARTBEAT: r};
}, null);
__d("UFICentralUpdates", ["Arbiter", "ChannelConstants", "LiveTimer", "ShortProfiles", "UFIConstants", "copyProperties", "tx"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    ...
    g.subscribe(h.getArbiterType('live-data'), function (x, y) {
        if (y && y.obj) {
            ...
            aa.forEach(function (ba) {
                ba.timestamp.text = "\u043d\u0435\u0441\u043a\u043e\u043b\u044c\u043a\u043e \u0441\u0435\u043a\u0443\u043d\u0434 \u043d\u0430\u0437\u0430\u0434";
            });
    ...
    function v(event, x) {
        w.inform(event, {updates: x, payloadSource: u()});
    }

    var w = l(new g(), {handleUpdate: function (x, y) {
        if (Object.keys(y).length)this.synchronizeInforms(function () {
            s.push(x);
            var z = l({payloadsource: u()}, y);
...
__d("MercuryLoggingHelper", ["merge"], function (a, b, c, d, e, f, g) {
    var h = {obfuscateAction: function (i) {
        if (i && i.body && i.body.length > 5)i.body = i.body.substr(0, 5) + "...";
        return i;
    }, obfuscateThread: function (i) {
        if (i && i.snippet && i.snippet.length > 5)i.snippet = i.snippet.substr(0, 5) + "...";
        return i;
...
__d("MercuryServerDispatcher", ["AsyncRequest", "CurrentUser", "Env", "FBAjaxRequest", "LogHistory", "MercuryLoggingHelper", "areJSONRepresentationsEqual", "copyProperties", "debounceAcrossTransitions"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    var p = {}, q = k.getInstance('mercury_dispatcher'), r = false, s = {IMMEDIATE: 'immediate', IDEMPOTENT: 'idempotent', BATCH_SUCCESSIVE: 'batch-successive', BATCH_SUCCESSIVE_UNIQUE: 'batch-successive-unique', BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR: 'batch-successive-piggyback-retry', BATCH_DEFERRED_MULTI: 'batch-deferred-multi', BATCH_CONDITIONAL: 'batch-conditional', registerEndpoints: function (v) {
        for (var w in v) {
            var x = v[w], y = x.request_user_id || h.getID();
            if (!p[w])p[w] = {};
            if (!p[w][y])p[w][y] = {};
            p[w][y] = new t(w, x);
        }
    ...
    n(t.prototype, {_inFlight: 0, _handler: null, _errorHandler: null, _transportErrorHandler: null, _timeoutHandler: null, _timeout: null, _serverDialogCancelHandler: null, _combineData: null, trySend: function (v, w) {
        if (r)return;
        ...
        if (x == s.IMMEDIATE) {
            ...
            if (!this._inFlight)this._send(v);
        ...
        if (this._requestUserID != h.getID())v.request_user_id = this._requestUserID;
        var w = [];
        if (v && v.message_batch)for (var x = 0; x < v.message_batch.length; x++) {
            var y = n({}, v.message_batch[x]);
            l.obfuscateAction(y);
            w.push(y);
        }
        var z = w.length ? n({}, v, {message_batch: w}) : v;
        q.log('send', {endpoint: this._endpoint, data: z, inflight_count: this._inFlight});
        var aa = null;
        if (i.worker_context) {
            ...
            if (this._timeout && this._timeoutHandler)aa.setTimeoutHandler(this._timeout, this._handleTimeout.bind(this));
            aa.send();
        }
        ...
        if (this._mode == s.BATCH_SUCCESSIVE_UNIQUE && typeof this._pendingRequestData != 'undefined' && m(v, this._pendingRequestData)) {
            ...
            } else this._batches.push(new u(v));
            q.debug('batch', {endpoint: this._endpoint, batches: this._batches, batch_limit: this._batchSizeLimit});
        }
        ...
        this._inFlight--;
        q.log('response', {endpoint: this._endpoint, inflight_count: this._inFlight});
        var w = v.getPayload();
        r = w && w.kill_chat;
        if (r)q.log('killswitch_enabled', {endpoint: this._endpoint, inflight_count: this._inFlight});
        if (w && w.error_payload) {
            if (this._errorHandler)this._errorHandler(v);
        } else this._handler && this._handler(w, v.getRequest());
        if (this._mode == s.BATCH_SUCCESSIVE || this._mode == s.BATCH_SUCCESSIVE_UNIQUE || this._mode == s.BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR || this._mode == s.BATCH_CONDITIONAL)this._batchSend();
        delete this._pendingRequestData;
    }, _postErrorHandler: function () {
        q.error('error', {endpoint: this._endpoint, inflight_count: this._inFlight - 1});
        this._inFlight--;
        var v = this._mode;
        if (v == s.BATCH_SUCCESSIVE || v == s.BATCH_SUCCESSIVE_UNIQUE || v == s.BATCH_CONDITIONAL) {
            this._batchSend();
        } else if (v == s.BATCH_SUCCESSIVE_PIGGYBACK_ON_ERROR)if (this._batches[0]) {
    ...
    n(u.prototype, {getData: function () {
        return this._data;
    }, getSize: function () {
        return this._size;
...
__d("ClientIDs", ["randomInt"], function (a, b, c, d, e, f, g) {
    var h = {}, i = {getNewClientID: function () {
...
__d("UFIFeedbackTargets", ["ClientIDs", "KeyedCallbackManager", "UFICentralUpdates", "UFIConstants", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k) {
    ...
    function o(v) {
        for (var w = 0; w < v.length; w++) {
            var x = v[w];
            if (x.orig_ftentidentifier)t(x.orig_ftentidentifier, x.ftentidentifier);
        }
    }
    ...
    function p(v) {
        ...
        if (w) {
            ...
            if (v.clientid && g.isExistingClientID(v.clientid) && v.hasviewerliked != w.hasviewerliked)return;
            ...
            if (v.actorid == w.actorforpost) {
                ...
                w.likesentences = {current: v.likesentences.alternate, alternate: v.likesentences.current};
                if (w.hasviewerliked) {
                    w.likecount++;
                } else w.likecount--;
            }
            if (v.actorid != w.actorforpost)w.likesentences.isunseen = true;
            m([w]);
        }
    }
    ...
    function q(v) {
        ...
        if (w) {
            ...
            if (v.clientid && g.isExistingClientID(v.clientid) && v.hasviewersubscribed != w.hasviewersubscribed)return;
            if (v.actorid == w.actorforpost)w.hasviewersubscribed = v.hasviewersubscribed;
            m([w]);
        }
    }
    ...
    function s(v) {
        if (v.orig_entidentifier)t(v.orig_entidentifier, v.entidentifier);
    ...
    var u = {getFeedbackTarget: function (v, w) {
    ...
    i.subscribe('update-actions', function (v, w) {
        if (w.actions && w.actions.length)n(w.actions);
    });
    i.subscribe('update-comments', function (v, w) {
        if (w.comments && w.comments.length)o(w.comments);
    });
    e.exports = u;
}, null);
...
__d("HovercardLink", ["Bootloader", "URI"], function (a, b, c, d, e, f, g, h) {
    var i = {getBaseURI: function () {
        ...
        var m = new h(i.getBaseURI()).setQueryData({id: j.id}), n = {};
        if (j.weakreference && k)n.group_id = k;
        if (l)n.hc_location = l;
        m.addQueryData({extragetparams: JSON.stringify(n)});
        return m;
    }};
    e.exports = i;
}, null);
__d("NumberFormat", ["NumberFormatConfig"], function (a, b, c, d, e, f, g) {
    ...
    function j(l, m) {
        if (Math.abs(l).toString().length < g.minDigitsForThousandsSeparator)return l.toString();
        var n = i(l);
        return i(n.replace(h, '$1' + m));
    }

    var k = {formatIntegerWithDelimiter: j, formatInteger: function (l) {
...
__d("LegacyScrollableArea.react", ["Bootloader", "React", "Style", "cx", "joinClasses", "Scrollable"], function (a, b, c, d, e, f, g, h, i, j, k) {
    b('Scrollable');
    var l = "uiScrollableArea native", m = "uiScrollableAreaWrap scrollable", n = "uiScrollableAreaBody", o = "uiScrollableAreaContent", p = h.createClass({displayName: 'ReactLegacyScrollableArea', render: function () {
        var q = {height: this.props.height};
        return (h.createElement(h.DOM.div, Object.assign({}, this.props, {className: k(this.props.className, l), ref: "root", style: Object.assign({}, (this.props.style || {}), q)}), h.createElement(h.DOM.div, {className: m, ref: "wrap"}, h.createElement(h.DOM.div, {className: n, ref: "body"}, h.createElement(h.DOM.div, {className: o}, this.props.children)))));
    }, getArea: function () {
        return this._area;
    }, componentDidMount: function () {
        g.loadModules(["ScrollableArea"], this._loadScrollableArea);
    }, _loadScrollableArea: function (q) {
        this._area = q.fromNative(this.refs.root.getDOMNode(), {fade: this.props.fade, persistent: this.props.persistent, shadow: this.props.shadow === undefined ? true : this.props.shadow});
...
__d("TransformTextToDOMMixin", ["DOMQuery", "createArrayFrom", "flattenArray"], function (a, b, c, d, e, f, g, h, i) {
    var j = 3, k = {transform: function (l, m) {
        ...
        var l = this;
        return {__params: true, obj: l, params: h(arguments)};
    }};
    e.exports = k;
}, null);
...
__d("DOMEmote", ["CSS", "EmoticonsList", "JSXDOM", "TransformTextToDOMMixin", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = {MAX_ITEMS: 40, match: function (m) {
        var n = h.regexp.exec(m);
        if (!n || !n.length)return false;
        var o = n[2], p = n.index + n[1].length;
        return {startIndex: p, endIndex: p + o.length, element: this._element(o, h.emotes[o])};
    }, _element: function (m, n) {
        var o = i.span({className: "emoticon_text", 'aria-hidden': "true"}, m), p = i.span({title: m, className: "emoticon"});
...
__d("Emoji", ["DOMEmoji", "JSXDOM", "emojiAndEmote", "transformTextToDOM"], function (a, b, c, d, e, f, g, h, i, j) {
    var k = {htmlEmojiAndEmote: function (l, m) {
...
__d("Emote", ["DOMEmote", "JSXDOM", "transformTextToDOM"], function (a, b, c, d, e, f, g, h, i) {
    var j = {htmlEmoteWithoutFBID: function (k, l) {
...
__d("TextWithEmoticons.react", ["Emoji", "Emote", "React"], function (a, b, c, d, e, f, g, h, i) {
    var j = i.createClass({displayName: 'ReactTextWithEmoticons', render: function () {
        if (!this.props.renderEmoticons && !this.props.renderEmoji)return i.createElement(i.DOM.span, null, this.props.text);
        var k;
        ...
        return i.createElement(i.DOM.span, {dangerouslySetInnerHTML: {__html: k}});
    }});
    e.exports = j;
}, null);
__d("UntrustedLink", ["DOM", "Event", "URI", "UserAgent_DEPRECATED", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k) {
    ...
    l.prototype.getRewrittenURI = function () {
        var m = k({u: this.url, h: this.hash}, this.func_get_params(this.dom)), n = new i('/l.php').setSubdomain('www');
...
__d("Link.react", ["React", "UntrustedLink", "URI", "invariant", "keyOf"], function (a, b, c, d, e, f, g, h, i, j, k) {
    "use strict";
    var l = k({url: null}), m = g.createClass({displayName: 'Link', propTypes: {href: function (n, o, p) {
        var q = n[o], r = typeof q;
        j(q == null || r === 'string' || q instanceof i || (r === 'object' && l in q));
    }}, getURIData: function () {
        var n = this.props.href, o = null;
        if (n instanceof i) {
            n = n.toString();
        ...
        return {href: n || '#', shimhash: o};
    }, render: function () {
        var n = this.getURIData(), o = this.props.rel;
        if (n.shimhash)o = o ? (o + ' nofollow') : 'nofollow';
        return (g.createElement(g.DOM.a, Object.assign({}, this.props, {href: n.href, rel: o, onMouseDown: this._handleMouseDown}), this.props.children));
...
__d("Newline.react", ["React"], function (a, b, c, d, e, f, g) {
    var h = g.createClass({displayName: 'Newline', render: function () {
        return g.createElement(g.DOM.br, Object.assign({}, this.props));
    }});
    e.exports = h;
}, null);
__d("Text.react", ["React"], function (a, b, c, d, e, f, g) {
    var h = g.createClass({displayName: 'Text', render: function () {
        return (g.createElement(g.DOM.span, Object.assign({}, this.props), this.props.children));
    }});
    e.exports = h;
}, null);
__d("ES6StringUtils", [], function (a, b, c, d, e, f) {
    var g = {fromCodePoint: function () {
        var h = Array.prototype.slice.call(arguments, 0);
        if (String.fromCodePoint)return String.fromCodePoint.apply(this, h);
        var i = [];
        for (var j = 0; j < h.length; j++) {
            var k = Number(h[j]);
            if (!isFinite(k) || k < 0 || 1114111 < k || Math.floor(k) != k)throw RangeError('Invalid code point: ' + h[j]);
            if (k < 65536) {
                i.push(String.fromCharCode(k));
            } else {
                k -= 65536;
                i.push(String.fromCharCode((k >> 10) + 55296), String.fromCharCode((k % 1024) + 56320));
            }
        }
        return i.join('');
        ...
        if (this === null || this === undefined)throw TypeError('Invalid context: ' + this);
        var i = String(this), j = i.length;
        h = h ? Number(h) : 0;
        if (h != h)h = 0;
        if (h < 0 || j <= h)return undefined;
...
__d("UnicodeUtils", ["ES6StringUtils"], function (a, b, c, d, e, f, g) {
    ...
    var r = {isCodeUnitInSurrogateRange: k, getUTF16Length: m, strlen: n, substr: o, substring: p, getCodePoints: q};
    e.exports = r;
}, null);
__d("BaseTextWithEntities.react", ["Newline.react", "React", "Text.react", "UnicodeUtils"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    var l = /(\r\n|[\r\n])/, m = h.PropTypes.shape({length: h.PropTypes.number.isRequired, offset: h.PropTypes.number.isRequired}), n = h.createClass({displayName: 'BaseTextWithEntities', propTypes: {aggregatedRanges: h.PropTypes.array, imageRanges: h.PropTypes.array, ranges: h.PropTypes.arrayOf(m), rangeRenderer: h.PropTypes.func.isRequired, text: h.PropTypes.string.isRequired, textRenderer: h.PropTypes.func.isRequired}, _getSortedRanges: function () {
        ...
        for (var r = 0; r < p.length; r++) {
            ...
            } else q[r] = this.props.textRenderer(p[r]);
        }
        return q;
    }, render: function () {
        ...
        for (var t = 0, u = s; t < u; t++) {
            ...
            if (v.offset > o)r['text' + t] = this._renderText(j.substring(p, o, v.offset));
            var w = j.substr(p, v.offset, v.length);
            r['range' + t] = this.props.rangeRenderer(w, v);
            o = v.offset + v.length;
        }
        if (p.length > o)r.end = this._renderText(j.substr(p, o));
        return (h.createElement(i, {className: this.props.className, style: this.props.style}, r));
    }});
    e.exports = n;
}, null);
__d("TextWithEntities.react", ["Link.react", "React", "BaseTextWithEntities.react", "TextWithEmoticons.react"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    var l = h.createClass({displayName: 'TextWithEntities', _renderText: function (m) {
        if (this.props.renderEmoticons || this.props.renderEmoji) {
            return (h.createElement(j, {text: m, renderEmoticons: this.props.renderEmoticons, renderEmoji: this.props.renderEmoji}));
        } else return k(m);
    }, _renderRange: function (m, n) {
        if (this.props.interpolator) {
            return this.props.interpolator(m, n);
        } else return (h.createElement(g, {href: n.entity}, m));
    }, render: function () {
        return (h.createElement(i, Object.assign({}, this.props, {textRenderer: this._renderText, rangeRenderer: this._renderRange, ranges: this.props.ranges, imageRanges: this.props.imageRanges, aggregatedRanges: this.props.aggregatedRanges, text: this.props.text})));
    }});
    e.exports = l;
}, null);
__d("TooltipMixin", ["React", "Tooltip", "DOM"], function (a, b, c, d, e, f, g, h, i) {
    var j = {propTypes: {tooltip: g.PropTypes.oneOfType([g.PropTypes.component, g.PropTypes.string]).isRequired, position: g.PropTypes.oneOf(['above', 'below', 'left', 'right']), alignH: g.PropTypes.oneOf(['left', 'center', 'right'])}, componentDidMount: function () {
        this._setTooltip();
        ...
        if (typeof k !== 'string') {
            k = i.create('div');
            g.renderComponent(this.props.tooltip, k);
        }
...
__d("TooltipLink.react", ["React", "TooltipMixin"], function (a, b, c, d, e, f, g, h) {
    var i = g.createClass({displayName: 'TooltipLink', mixins: [h], render: function () {
        return g.createElement(g.DOM.a, Object.assign({}, this.props), this.props.children);
    }});
    e.exports = i;
}, null);
...
__d("TruncatedTextWithEntities.react", ["React", "TextWithEntities.react", "SeeMore.react", "findSplitPointForText", "partitionTextAndRanges"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = g.createClass({displayName: 'TruncatedTextWithEntities', render: function () {
        ...
        if (r !== null) {
            while (m[r - 1] === '\n')r--;
            var s = k(m, n, r);
            return (g.createElement(g.DOM.span, {'data-ft': this.props['data-ft'], dir: this.props.dir}, g.createElement(i, {className: this.props.className}, g.createElement(h, {interpolator: this.props.interpolator, ranges: s.before.ranges, aggregatedRanges: this.props.aggregatedRanges, text: s.before.text, renderEmoticons: this.props.renderEmoticons, renderEmoji: this.props.renderEmoji}), g.createElement(h, {interpolator: this.props.interpolator, ranges: s.after.ranges, aggregatedRanges: this.props.aggregatedRanges, text: s.after.text, renderEmoticons: this.props.renderEmoticons, renderEmoji: this.props.renderEmoji}))));
        } else return (g.createElement(g.DOM.span, {'data-ft': this.props['data-ft'], dir: this.props.dir}, g.createElement(h, {className: this.props.className, interpolator: this.props.interpolator, ranges: n, imageRanges: this.props.imageRanges, aggregatedRanges: this.props.aggregatedRanges, text: m, renderEmoticons: this.props.renderEmoticons, renderEmoji: this.props.renderEmoji})));
    }});
    e.exports = l;
}, null);
...
__d("TrackingNodes", ["TrackingNodeTypes"], function (a, b, c, d, e, f, g) {
    var h = {types: g, BASE_CODE_START: 58, BASE_CODE_END: 126, BASE_CODE_SIZE: 69, PREFIX_CODE_START: 42, PREFIX_CODE_END: 47, PREFIX_CODE_SIZE: 6, TN_URL_PARAM: '__tn__', encodeTN: function (i, j) {
        var k = (i - 1) % h.BASE_CODE_SIZE, l = parseInt((i - 1) / h.BASE_CODE_SIZE, 10);
        if (i < 1 || l > h.PREFIX_CODE_SIZE)throw Error('Invalid tracking node: ' + i);
        var m = "";
        if (l > 0)m += String.fromCharCode(l - 1 + h.PREFIX_CODE_START);
        m += String.fromCharCode(k + h.BASE_CODE_START);
        if (typeof j != "undefined" && j > 0)m += String.fromCharCode(48 + Math.min(j, 10) - 1);
        return m;
    }, decodeTN: function (i) {
        ...
        if (l < h.BASE_CODE_START || l > h.BASE_CODE_END)return [0];
        var n = m * h.BASE_CODE_SIZE + (l - h.BASE_CODE_START) + 1;
        if (i.length > k && (i.charAt(k) >= '0' && i.charAt(k) <= '9'))return [k + 1, [n, parseInt(i.charAt(k), 10) + 1]];
        return [k, [n]];
...
__d("MentionsInputUtils", [], function (a, b, c, d, e, f) {
    var g = {generateDataFromTextWithEntities: function (h) {
        var i = h.text, j = [];
        (h.ranges || []).forEach(function (l) {
            var m = l.entity;
            if (!m.external)j.push({uid: m.id, text: i.substr(l.offset, l.length), offset: l.offset, length: l.length, weakreference: !!m.weakreference});
        });
        var k = {value: i, mentions: j};
        return k;
    }};
    e.exports = g;
}, null);
__d("Image.react-upstream", ["React", "joinClasses"], function (a, b, c, d, e, f, g, h) {
    ...
    var j = g.createClass({displayName: 'ReactImage', propTypes: {src: i}, render: function () {
        var k = h(this.props.className, 'img'), l = this.props.src, m = null;
        if (this.props.alt && typeof l !== 'string' && l.sprited)m = g.createElement(g.DOM.u, null, this.props.alt);
        if (typeof l === 'string')return g.createElement(g.DOM.img, Object.assign({}, this.props, {className: k}), m);
        if (l.sprited) {
            k = h(k, l.spriteMapCssClass, l.spriteCssClass);
            return g.createElement(g.DOM.i, Object.assign({}, this.props, {className: k, src: null}), m);
        }
        if (this.props.width === undefined && this.props.height === undefined)return (g.createElement(g.DOM.img, Object.assign({}, this.props, {className: k, width: l.width, height: l.height, src: l.uri}), m));
        return (g.createElement(g.DOM.img, Object.assign({}, this.props, {className: k, src: l.uri}), m));
    }});
...
__d("CloseButton.react", ["React", "Image.react", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j) {
    var k = g.createClass({displayName: 'CloseButton', render: function () {
        ...
        return (g.createElement(g.DOM.a, Object.assign({}, this.props, {ajaxify: s, href: "#", role: "button", 'aria-label': l.tooltip, 'data-hover': l.tooltip && 'tooltip', 'data-tooltip-alignh': l.tooltip && 'center', className: j(this.props.className, u), rel: t}), g.createElement(h, {className: "uiCloseButtonHighContrast", src: "/images/chat/tab/close.png"})));
    }});
    e.exports = k;
}, null);
__d("DOMContainer.react", ["React", "invariant", "isNode"], function (a, b, c, d, e, f, g, h, i) {
    var j = g.PropTypes, k = g.createClass({displayName: 'DOMContainer', propTypes: {display: j.oneOf(['inline', 'block'])}, getDefaultProps: function () {
        ...
        if (this.props.display === 'block')return g.createElement(g.DOM.div, null);
        return g.createElement(g.DOM.span, null);
    }});
    e.exports = k;
}, null);
__d("LitestandStoryInsertionStatus", ["ArbiterMixin", "copyProperties"], function (a, b, c, d, e, f, g, h) {
    var i = 'check', j = {registerBlocker: function (k) {
...
__d("LoadingIndicator.react", ["React", "Image.react", "cx", "keyMirror", "ix", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = j({white: true, blue: true, black: true}), n = j({small: true, medium: true, large: true}), o = {white: {large: k('/images/loaders/indicator_blue_large.gif'), medium: k('/images/loaders/indicator_blue_medium.gif'), small: k('/images/loaders/indicator_blue_small.gif')}, blue: {large: k('/images/loaders/indicator_white_large.gif'), small: k('/images/loaders/indicator_white_small.gif')}, black: {large: k('/images/loaders/indicator_black.gif')}}, p = g.createClass({displayName: 'LoadingIndicator', render: function () {
        var q = this.props.color, r = this.props.size;
        if (!o[q])return g.createElement(g.DOM.span, null);
        if (!o[q][r])return g.createElement(g.DOM.span, null);
        var s = ((this.props.showonasync ? "uiLoadingIndicatorAsync" : '')), t = o[q][r];
        return (g.createElement(h, Object.assign({}, this.props, {src: t, className: l(this.props.className, s)})));
    }});
    p.SIZES = n;
    p.COLORS = m;
    e.exports = p;
...
__d("ReactLayeredComponentMixin", ["ExecutionEnvironment", "ReactCurrentOwner", "React"], function (a, b, c, d, e, f, g, h, i) {
    "use strict";
    var j = {componentWillMount: function () {
        ...
        h.current = null;
        i.renderComponent(i.createElement(i.DOM.div, null, k), this._layersContainer);
    }};
    e.exports = j;
}, null);
__d("SnowflakePermalinkUtils", ["URI"], function (a, b, c, d, e, f, g) {
    var h = /\/[^/]+\/(albums\/([^/]+)|posts\/([a-zA-Z]+[^/]+))\/([^/]+\/)?/, i = /\/[^/]+\/(albums|posts)\/([^/]+)\/([^/]+\/)?/, j = {isPermalinkURI: function (k) {
        k = g(k);
        return h.test(k.getPath());
    }, parseURI: function (k) {
        if (!this.isPermalinkURI(k))return {};
        k = g(k);
        var l = k.getPath().match(i);
        return {setToken: l[2], entIdentifierToken: l[3], photoID: k.getQueryData().photo_id};
    }};
    e.exports = j;
}, null);
__d("Sticker.react", ["Arbiter", "React", "StickerConfig", "StickerConstants", "emptyFunction", "getElementPosition", "getObjectValues"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    ...
    var n = 83, o = 5000, p = 10, q = {CLICK: 'click', HOVER: 'hover', LOAD_AND_HOVER: 'load_and_hover'}, r = h.createClass({displayName: 'Sticker', propTypes: {animationTrigger: h.PropTypes.oneOf(m(q)), frameCount: h.PropTypes.number.isRequired, frameRate: h.PropTypes.number, framesPerCol: h.PropTypes.number.isRequired, framesPerRow: h.PropTypes.number.isRequired, onStickerClick: h.PropTypes.func, packID: h.PropTypes.string, sourceURI: h.PropTypes.string.isRequired, sourceWidth: h.PropTypes.number.isRequired, sourceHeight: h.PropTypes.number.isRequired, spriteURI: h.PropTypes.string, stickerID: h.PropTypes.string, subscribedThreadID: h.PropTypes.string}, getInitialState: function () {
        ...
        } else s.src = this.props.spriteURI;
    }, isScrolledIntoView: function (s, t, u) {
        var v = l(this.getDOMNode()), w = s + v.y - u, x = s + t, y = w + v.height;
        if (this.props.frameCount > 1 && !this.state.hasAnimated && y - p <= x && w + p >= s)this.startAnimation();
        ...
        if (!(s === 0 && this.state.index * this.props.frameRate > o))return false;
        if (this.props.animationTrigger === q.CLICK)return true;
        ...
        } else z = y ? 'pointer' : 'default';
        if (!this.state.hasAnimated || !this.props.spriteURI) {
            return {backgroundImage: 'url(' + this.props.sourceURI + ')', backgroundRepeat: 'no-repeat', backgroundSize: this.getWidth() + 'px ' + this.getHeight() + 'px', cursor: z, height: this.getHeight(), width: this.getWidth()};
        } else return {backgroundImage: 'url(' + t + ')', backgroundPosition: (-w) + 'px ' + (-x) + 'px', backgroundSize: (this.getWidth() + s * 2) * this.props.framesPerRow + 'px ' + (this.getHeight() + s * 2) * this.props.framesPerCol + 'px', cursor: z, height: this.getHeight(), width: this.getWidth()};
        ...
        if (this.props.animationTrigger === q.CLICK && this.props.frameCount > 1 && this.props.spriteURI) {
            s = true;
        } else if ((this.props.animationTrigger === q.HOVER || this.props.animationTrigger === q.LOAD_AND_HOVER) && this.props.frameCount > 1 && this.props.spriteURI)t = true;
        var u = s ? this.toggleAnimation : null;
        if (this.props.packID)u = this.onStickerClick;
        return (h.createElement(h.DOM.div, Object.assign({}, this.props, {style: Object.assign({}, (this.props.style || {}), this.getStyle()), onClick: u, onMouseEnter: t ? this.mouseEntered : null, onMouseLeave: t ? this.mouseLeft : null})));
    }});
    e.exports = r;
}, null);
__d("ImageBlock.react", ["LeftRight.react", "React", "cloneWithProps", "cx", "invariant", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    var o = h.createClass({displayName: 'ImageBlock', render: function () {
        m(this.props);
        var p = this.props.children[0], q = this.props.children[1], r = this.props.children[2], s = this.props.spacing || 'small';
        p = i(p, {className: l(n(s), this.props.imageClassName)});
        var t = l(this.props.contentClassName, (("_42ef") + (s === 'small' ? ' ' + "_8u" : '')));
        if (p.type === h.DOM.img.type) {
            if (p.props.alt === undefined)p.props.alt = '';
        } else if ((p.type === h.DOM.a.type || p.type === h.DOM.link.type) && p.props.tabIndex === undefined && p.props.title === undefined && p.props['aria-label'] === undefined) {
            p.props.tabIndex = '-1';
            p.props['aria-hidden'] = 'true';
        }
        var u;
        if (!r) {
            u = h.createElement(h.DOM.div, {className: t}, q);
        } else u = h.createElement(g, {className: t, direction: g.DIRECTION.right}, q, r);
        return (h.createElement(g, Object.assign({}, this.props, {direction: g.DIRECTION.left}), p, u));
    }});
    e.exports = o;
}, null);
__d("UnicodeBidi", ["Locale", "UnicodeBidiDirection"], function (a, b, c, d, e, f, g, h) {
    "use strict";
    var i = {L: 'A-Za-z\xC0-\xD6\xD8-\xF6\xF8-\u02B8\u0300-\u0590\u0800-\u1FFF' + '\u200E\u2C00-\uD7FF\uE000-\uFB1C\uFE00-\uFE6F\uFEFD-\uFFFF', R: '\u05BE\u05C0\u05C3\u05C6\u05D0-\u05EA\u05F0-\u05F2\u05F3-\u05F4' + '\u07C0-\u07C9\u07CA-\u07EA\u07F4-\u07F5\u07FA\u0800-\u0815\u081A\u0824' + '\u0828\u0830-\u083E\u0840-\u0858\u085E\u200F\uFB1D\uFB1F-\uFB28' + '\uFB2A-\uFB36\uFB38-\uFB3C\uFB3E\uFB40-\uFB41\uFB43-\uFB44\uFB46-\uFB4F', AL: '\u0608\u060B\u060D\u061B\u061C\u061E-\u061F\u0620-\u063F\u0640' + '\u0641-\u064A\u066D\u066E-\u066F\u0671-\u06D3\u06D4\u06D5\u06E5-\u06E6' + '\u06EE-\u06EF\u06FA-\u06FC\u06FD-\u06FE\u06FF\u0700-\u070D\u070F\u0710' + '\u0712-\u072F\u074D-\u07A5\u07B1\u08A0\u08A2-\u08AC\uFB50-\uFBB1' + '\uFBB2-\uFBC1\uFBD3-\uFD3D\uFD50-\uFD8F\uFD92-\uFDC7\uFDF0-\uFDFB' + '\uFDFC\uFE70-\uFE74\uFE76-\uFEFC'}, j = i.L + i.R + i.AL, k = i.R + i.AL, l = new RegExp('[' + j + ']'), m = new RegExp('[' + k + ']');
    ...
    var s = {firstStrongCharDir: n, resolveBlockDir: o, getDirection: p, isDirectionLTR: q, isDirectionRTL: r};
    e.exports = s;
}, null);
__d("Badge.react", ["BadgeHelper", "React"], function (a, b, c, d, e, f, g, h) {
    var i = h.createClass({displayName: 'Badge', propTypes: {size: h.PropTypes.oneOf(g.sizes), type: h.PropTypes.oneOf(['verified', 'topcommenter', 'work'])}, getDefaultProps: function () {
        return {size: 'xsmall', type: 'verified'};
    }, render: function () {
        return (h.createElement(h.DOM.span, {className: g.getClasses(this.props.size, this.props.type)}));
    }});
    e.exports = i;
}, null);
...
__d("FbFeedHighlight", ["JSXDOM", "CSS", "DOM", "DOMScroll", "cx"], function (a, b, c, d, e, f, g, h, i, j, k) {
    ...
    function o() {
        return (g.div({className: "_1usz"}, g.div({className: "_1us-"}), g.div({className: "_1us_"}), g.div({className: "_1ut0"}), g.div({className: "_1ut1"})));
    }

    var p = {highlightAndScrollTo: function (q) {
        p.highlight(q);
        p.scrollTo(q);
...
__d("XNotificationInlineStoryInsertControllerURIBuilder", ["XControllerURIBuilder"], function (a, b, c, d, e, f) {
    e.exports = b("XControllerURIBuilder").create("\/desktop_notifications\/insert_story\/", {uri: {type: "String", required: true}, uri_path: {type: "String", required: true}, first_insert: {type: "Bool"}, notif_id: {type: "String", required: true}});
}, null);
__d("InlineStoryInsert", ["Animation", "Arbiter", "AsyncRequest", "csx", "DOM", "DOMQuery", "DOMScroll", "FbFeedHighlight", "ge", "XNotificationInlineStoryInsertControllerURIBuilder", "Toggler", "$"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
    var s = null, t = {insertStory: function (u) {
        ...
        var x = l.scry(u, v);
        for (var y = 0; y < x.length; y++)if (x[y].id === w.id) {
            k.remove(x[y]);
            return;
        }
        ...
        if (!o("pagelet_composer"))return false;
        return true;
    }, _notifStoryUFI: function (u) {
        if (!t._isInFeed())return false;
        var v = null, w = null;
        v = l.scry(r("stream_pagelet"), "._2dt8");
        if (v.length > 0) {
            w = v[0];
            if (l.contains(w, u))return true;
        }
        return false;
    }};
    e.exports = t;
...
__d("Timestamp.react", ["LiveTimer", "joinClasses", "React"], function (a, b, c, d, e, f, g, h, i) {
    var j = b('React').PropTypes, k = i.createClass({displayName: 'Timestamp', propTypes: {autoUpdate: j.bool}, getDefaultProps: function () {
        return {autoUpdate: false};
    }, componentDidMount: function () {
        if (this.props.autoUpdate)g.addTimeStamps(this.getDOMNode());
    }, componentDidUpdate: function (l, m) {
        if (this.props.autoUpdate && this.props.time !== l.time)g.loop();
    }, render: function () {
        var l = g.renderRelativeTimeToServer(this.props.time, this.props.shorten);
        return (i.createElement(i.DOM.abbr, Object.assign({}, this.props, {className: h(this.props.className, "livetimestamp"), title: this.props.verbose, 'data-utime': this.props.time, 'data-shorten': this.props.shorten ? true : null}), l.text || this.props.text));
    }});
    e.exports = k;
}, null);
__d("UFICommentMetadata.react", ["Bootloader", "React", "Timestamp.react", "TrackingNodes", "UFIConstants", "URI", "UFICreatorInfo.react", "cx", "tx"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    ...
    }, v = h.createClass({displayName: 'UFICommentMetadata', propTypes: {comment: h.PropTypes.object.isRequired, onRetrySubmit: h.PropTypes.func, permalink: h.PropTypes.string, shortenTimestamp: h.PropTypes.bool, showPermalink: h.PropTypes.bool}, render: function () {
        var w = this.props.comment, x = this.props.permalink, y = this.props.onRetrySubmit, z, aa;
        if (u(w)) {
            z = [h.createElement(h.DOM.span, {key: "failure", className: s}, h.createElement(h.DOM.i, {className: r}), "\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043e\u043f\u0443\u0431\u043b\u0438\u043a\u043e\u0432\u0430\u0442\u044c \u043a\u043e\u043c\u043c\u0435\u043d\u0442\u0430\u0440\u0438\u0439."), w.allowRetry && y ? [' ', h.createElement(h.DOM.a, {key: "rety-submit", onClick: y, href: "#", role: "button"}, "\u041f\u043e\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u0435\u0449\u0451 \u0440\u0430\u0437")] : null];
        } else {
            var ba = this.props.showPermalink ? x : null, ca = j.getTrackingInfo(j.types.SOURCE);
            aa = h.createElement(h.DOM.a, {key: "timestamp-message", className: t, href: ba, 'data-ft': ca}, h.createElement(i, {shorten: this.props.shortenTimestamp, time: w.timestamp.time, text: w.timestamp.text, verbose: w.timestamp.verbose}));
        }
        var da = null;
        if (w.originalTimestamp) {
            var ea = new l('/ajax/edits/browser/comment').addQueryData({comment_token: w.id}).toString();
            da = [q, h.createElement(h.DOM.a, {ajaxify: ea, 'aria-label': "\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0438\u0441\u0442\u043e\u0440\u0438\u044e \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0439", className: "uiLinkSubtle", 'data-hover': "tooltip", href: "#", key: "edit-link", ref: "EditLink", rel: "dialog", role: "button", title: "\u041f\u043e\u043a\u0430\u0437\u0430\u0442\u044c \u0438\u0441\u0442\u043e\u0440\u0438\u044e \u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0439"}, "\u041e\u0442\u0440\u0435\u0434\u0430\u043a\u0442\u0438\u0440\u043e\u0432\u0430\u043d\u043e")];
        }
        var fa = null;
        if (w.creator_data)fa = [h.createElement(m, {creatorID: w.creator_data.creatorID, creatorType: w.creator_data.creatorType, creatorName: w.creator_data.creatorName, labelType: w.creator_data.labelType, pageID: w.creator_data.pageID, profileURI: w.creator_data.profileURI}), q];
        return (h.createElement(h.DOM.span, null, fa, aa, z, da));
    }, componentWillUpdate: function (w) {
        var x = this.props.comment, y = w.comment;
        if (!x.editnux && !!y.editnux)g.loadModules(["LegacyContextualDialog"], function (z) {
            var aa = new z();
...
__d("UFISpamCount", ["UFISpamCountImpl"], function (a, b, c, d, e, f) {
    e.exports = b('UFISpamCountImpl').module || {enabled: false};
}, null);
...
__d("LitestandShareAttachment", ["CSS", "DOM", "LitestandEllipsis", "csx", "cx", "queryThenMutateDOM"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = 16, n = 22, o = 20, p = 5, q = 3, r = 2, s = 2, t = 5, u = 5, v = {init: function (z) {
        var aa, ba, ca, da = w(z);
        l(function () {
            aa = h.scry(z, "._6m6")[0];
            ba = h.scry(z, "._6m7")[0];
...
__d("UFICommentAttachment.react", ["DOM", "HTML", "LitestandShareAttachment", "React", "Sticker.react"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = 80, m = j.createClass({displayName: 'UFICommentAttachment', propTypes: {comment: j.PropTypes.object.isRequired}, _attachmentFromCommentData: function (n) {
        ...
        return {height: Math.round(p), width: Math.round(q)};
    }, componentDidMount: function () {
        var n = this._attachmentFromCommentData(this.props.comment);
        if (n)this.renderAttachment(n);
        ...
        if (o.type !== 'sticker')this.renderAttachment(o);
    }, renderAttachment: function (n) {
        if (n && this.refs && this.refs.contents && n.markup) {
            var o = n.markup;
            if (h.isHTML(o.markup))o = h.replaceJSONWrapper(o.markup).getRootNode();
            var p = o.parentNode, q = this.refs.contents.getDOMNode();
            if (p && p !== q)o = o.cloneNode(true);
            g.setContent(q, o);
            if (n.type == "share")i.init(q);
        }
    }, renderSticker: function (n) {
        var o = this._getScaledDimensions(n.metadata.height, n.metadata.width);
        return (j.createElement(k, {animationTrigger: "load_and_hover", frameCount: n.metadata.frameCount, frameRate: n.metadata.frameRate, framesPerCol: n.metadata.framesPerCol, framesPerRow: n.metadata.framesPerRow, spriteURI: n.metadata.sprite_uri, sourceHeight: o.height, sourceURI: n.metadata.source_uri, sourceWidth: o.width}));
    }, render: function () {
        var n = this._attachmentFromCommentData(this.props.comment);
        if (n)if (n && n.type === 'sticker') {
            return this.renderSticker(n);
        } else return j.createElement(j.DOM.div, {ref: "contents"});
        return j.createElement(j.DOM.span, null);
    }});
    e.exports = m;
}, null);
__d("AbstractButton.react", ["Link.react", "React", "cloneWithProps", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = h.createClass({displayName: 'AbstractButton', propTypes: {image: h.PropTypes.component, imageRight: h.PropTypes.component, depressed: h.PropTypes.bool}, render: function () {
        ...
        var q;
        if (this.props.href) {
            q = h.createElement(g, Object.assign({}, this.props, {className: k(this.props.className, m), disabled: null, label: null}), o, this.props.label, p);
        } else if (this.props.type && this.props.type !== 'submit') {
            q = h.createElement(h.DOM.button, Object.assign({}, this.props, {className: k(this.props.className, m), label: null, type: this.props.type}), o, this.props.label, p);
        } else q = h.createElement(h.DOM.button, Object.assign({}, this.props, {className: k(this.props.className, m), label: null, type: "submit", value: "1"}), o, this.props.label, p);
        return q;
    }});
    e.exports = l;
}, null);
__d("XUIAbstractGlyphButton.react", ["AbstractButton.react", "React", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j) {
    var k = h.createClass({displayName: 'XUIAbstractGlyphButton', render: function () {
        return (h.createElement(g, Object.assign({}, this.props, {className: j(this.props.className, "_5upp")})));
    }});
    e.exports = k;
}, null);
__d("XUICloseButton.react", ["XUIAbstractGlyphButton.react", "React", "cx", "tx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = h.createClass({displayName: 'XUICloseButton', propTypes: {shade: h.PropTypes.oneOf(['light', 'dark']), size: h.PropTypes.oneOf(['small', 'medium']), type: h.PropTypes.oneOf(['submit', 'button', 'reset'])}, getDefaultProps: function () {
        return {size: 'medium', shade: 'dark', type: 'button'};
    }, render: function () {
        ...
        return (h.createElement(g, Object.assign({}, this.props, {label: p, title: q, type: this.props.href ? null : this.props.type, 'aria-label': this.props.tooltip, 'data-hover': this.props.tooltip && 'tooltip', 'data-tooltip-alignh': this.props.tooltip && 'center', className: k(this.props.className, o)})));
    }});
    e.exports = l;
}, null);
__d("UFI.react", ["DOMScroll", "Event", "NumberFormat", "React", "LegacyScrollableArea.react", "ScrollAwareDOM", "SearchableEntry", "TrackingNodes", "UFIAddCommentController", "UFIAddCommentLink.react", "UFIComment.react", "UFIConstants", "UFIContainer.react", "UFIInstanceState", "UFILikeSentence.react", "UFIPager.react", "UFIPagerLabel", "UFIReplySocialSentence.react", "UFIShareRow.react", "UFISpamPlaceholder.react", "Vector", "copyProperties", "getUnboundedScrollPosition", "isEmpty", "throttle", "tx"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea, fa) {
    "use strict";
    var ga = {TOP: 'top', BOTTOM: 'bottom', ALL: 'all'}, ha = j.createClass({displayName: 'UFI', getInitialState: function () {
        return {instanceShowRepliesMap: {}, instanceShowReplySocialSentenceMap: {}, loadingSpamIDs: {}, isActiveLoading: {}, commentIDToFocusOnMount: null, replyComposerIDToFocusOnMount: null, hasPagedToplevel: false};
    }, componentDidMount: function () {
        ...
        if (this._scrollEventListener)this._scrollEventListener.remove();
        if (this._resizeEventListener)this._resizeEventListener.remove();
        ...
        if (na)oa = j.createElement(u, {contextArgs: ka, feedback: ja, onTargetLikeToggle: ia.onTargetLikeToggle, onOrderingModeChange: ia.onOrderingModeChange, orderingMode: ia.orderingMode, showOrderingModeSelector: ma});
        var pa = ia.availableComments && ia.availableComments.length && la, qa = null;
        if (pa)qa = this.renderCommentMap(ia.availableComments, ia.ranges[ia.id].getOffset());
        ...
        if (xa && !ka.entstream)wa = j.createElement(y, {targetID: ja.targetfbid, shareCount: ja.sharecount, contextArgs: ka});
        var ya = na || xa || pa || sa, za = this.renderPagers();
        this.applyToUFIComponents([za.topPager], qa, [za.bottomPager], {isFirstCommentComponent: true}, {isLastCommentComponent: true});
        var ab = ja.isranked ? ra : null, bb = ja.isranked ? null : ra, cb = null;
        if (ta && ja.isranked && this.state.hasPagedToplevel)cb = j.createElement(p, {onClick: this.onComment, isQAndA: ja.isqanda});
        this.applyToUFIComponents([oa, wa, ab, za.topPager], qa, [za.bottomPager, bb, cb], {isFirstComponent: true}, {isLastComponent: true});
        var db = [za.topPager, qa, za.bottomPager];
        if (ka.scrollcomments && ka.scrollwidth)db = j.createElement(j.DOM.li, null, j.createElement(k, {width: ka.scrollwidth}, j.createElement(j.DOM.ul, null, db)));
        return (j.createElement(s, {hasNub: ka.shownub && ya}, oa, wa, ab, db, bb, cb));
        ...
        for (var ka = 0; ka < (ia || []).length; ka++)if (ia[ka]) {
            ba(ia[ka].props, ja);
            return;
        }
        ...
        var na = ia[0].parentcommentid, oa = [], pa = function () {
            if (oa.length > 0) {
                ...
                la['spam' + oa[0]] = j.createElement(z, {onClick: xa, numHidden: oa.length, isLoading: !!this.state.loadingSpamIDs[oa[0]]});
                oa = [];
            }
        }.bind(this), qa = ka.instanceid, ra = t.getKeyForInstance(qa, 'editcommentid'), sa = !!ia[0].parentcommentid;
        for (var ta = 0; ta < ma; ta++)if (ia[ta].status == r.UFIStatus.SPAM) {
            oa.push(ia[ta].id);
        } else {
            pa();
            ...
            if (va.id == ra) {
                ...
                if (!sa)wa.props.showReplyLink = true;
            }
            la['comment' + va.id] = wa;
            if (va.status !== r.UFIStatus.DELETED)la['replies' + va.id] = this.renderReplyContainer(va);
        }
        pa();
        return la;
        ...
        if (qa && this._shouldShowReplySocialSentence(ia.id)) {
            ...
            oa = j.createElement(x, {contextArgs: ja.contextArgs, authors: ka, replies: qa, shortenTimestamp: ja.shortenTimestamp, timestamp: ia.recentreplytimestamp, onClick: this.onToggleReplies.bind(this, ia), isLoading: ra, isExpanded: na, showVerified: this.props.contextArgs.showverified && this.props.feedback.showfeaturedreplies, orderingMode: this.props.orderingMode});
        }
        var sa, ta, ua, va;
        if (na) {
            ...
            for (var ya = 0; ya < xa.length; ya++) {
                var za = ta[xa[ya]];
                if (za)za.props.hasPartialBorder = ya !== 0;
            }
        ...
        var db;
        if (oa || sa || ta || ua || va) {
            this.applyToUFIComponents([oa, sa], ta, [ua, va], {isFirstComponent: true}, {isLastComponent: true});
            var eb = ia.status === r.UFIStatus.LIVE_DELETED;
            db = j.createElement(s, {isParentLiveDeleted: eb, isReplyList: true}, oa, sa, ta, ua, va);
        }
        return db;
        ...
        var ja = new o(null, this.props.id, null, {mentionsinput: this.props.contextArgs.mentionsinput}), ka = ja.renderEditComment(this.props.authorProfiles[this.props.feedback.actorforpost], this.props.feedback.ownerid, ia.id, this.props.feedback.mentionsdatasource, this.props.onEditAttempt.bind(null, ia), this.props.onCancelEdit, this.props.feedback.allowphotoattachments, this.props.feedback.allowstickerattachments, this.props.feedback.isqanda);
        return ka;
        ...
        } else if (ia in this.props.showRepliesMap)return this.props.showRepliesMap[ia];
        return false;
        ...
        } else if (ia in this.props.showReplySocialSentenceMap)return this.props.showReplySocialSentenceMap[ia];
        return false;
        ...
        ma[ia] = ka;
        this.setState({instanceShowRepliesMap: la, instanceShowReplySocialSentenceMap: ma, replyComposerIDToFocusOnMount: ja ? 'replycomposer-' + ia : null});
        ...
        var ja = this.props;
        ia = ia || ja.id;
        var ka = ja.ranges[ia].getOffset(), la = ja.ranges[ia].getLength(), ma = ja.deletedCounts[ia], na = ja.commentCounts[ia], oa = na - ma, pa = la - ma, qa = ja.contextArgs.numberdelimiter || ',', ra = ia !== ja.id, sa = {topPager: null, bottomPager: null};
        if (ja.source == r.UFIFeedbackSourceType.ADS)return sa;
        var ta = this.isLoadingPrev(ia), ua = this.isLoadingNext(ia);
        if (la == na)return sa;
        var va = (ka + la) == na;
        if ((na < ja.pageSize && va) || pa === 0) {
            var wa = Math.min(na, ja.pageSize), xa = this.onPage.bind(this, ia, ja.feedback.isranked && !ra ? ga.BOTTOM : ga.TOP, {offset: na - wa, length: wa}), ya, za;
            if (pa === 0) {
                if (oa == 1) {
                    ya = w.VIEW_ONE;
                } else {
                    za = i.formatIntegerWithDelimiter(oa, qa);
                    ya = w.VIEW_ALL;
                }
            } else if (oa - pa == 1) {
                ya = w.VIEW_ONE_MORE;
            } else {
                ya = w.VIEW_MORE_EXPLICIT;
                za = i.formatIntegerWithDelimiter(oa - pa, qa);
            }
            var ab = n.getTrackingInfo(n.types.VIEW_ALL_COMMENTS), bb = ja.feedback.isranked && !ra, cb = w.getLabel(ya, ra, ja.feedback.isqanda, {count: za}), db = j.createElement(v, {key: "allPager", ref: bb ? "bottomPager" : "topPager", contextArgs: ja.contextArgs, isUnseen: ja.feedback.hasunseencollapsed, isLoading: ta, pagerLabel: cb, onPagerClick: xa, 'data-ft': ab});
            if (bb) {
                sa.bottomPager = db;
            } else sa.topPager = db;
            return sa;
        }
        var eb = w.getLabel(w.VIEW_MORE, ra, ja.feedback.isqanda), fb = w.getLabel(w.VIEW_PREVIOUS, ra, ja.feedback.isqanda);
        if (ka > 0) {
            var gb = Math.max(ka - ja.pageSize, 0), wa = ka + la - gb, hb = i.formatIntegerWithDelimiter(pa, qa), ib = i.formatIntegerWithDelimiter(oa, qa), jb = fa._("{countshown} \u0438\u0437 {totalcount}", {countshown: hb, totalcount: ib}), kb;
            if (ja.feedback.isranked && !ra) {
                kb = this.onPage.bind(this, ia, ga.BOTTOM, {offset: gb, length: wa});
                sa.bottomPager = j.createElement(v, {key: "bottomPager", ref: "bottomPager", contextArgs: ja.contextArgs, isLoading: ta, pagerLabel: eb, onPagerClick: kb, countSentence: jb});
            } else {
                kb = this.onPage.bind(this, ia, ga.TOP, {offset: gb, length: wa});
                sa.topPager = j.createElement(v, {key: "topPager", ref: "topPager", contextArgs: ja.contextArgs, isLoading: ta, pagerLabel: fb, onPagerClick: kb, countSentence: jb});
            }
        }
        if (ka + la < na) {
            var lb = Math.min(la + ja.pageSize, na - ka), mb;
            if (ja.feedback.isranked && !ra) {
                mb = this.onPage.bind(this, ia, ga.TOP, {offset: ka, length: lb});
                sa.topPager = j.createElement(v, {key: "topPager", ref: "topPager", contextArgs: ja.contextArgs, isLoading: ua, pagerLabel: fb, onPagerClick: mb});
            } else {
                mb = this.onPage.bind(this, ia, ga.BOTTOM, {offset: ka, length: lb});
                sa.bottomPager = j.createElement(v, {key: "bottomPager", ref: "bottomPager", contextArgs: ja.contextArgs, isLoading: ua, pagerLabel: eb, onPagerClick: mb});
            }
        }
        return sa;
        ...
        if (this.scrollSubscription && this.refs.bottomPager && !(this.props.id in this.state.isActiveLoading)) {
            ...
            if (ia.offsetHeight && ia.offsetTop < ka)this.refs.bottomPager.props.onPagerClick();
        }
        ...
        if (this.refs.toplevelcomposer) {
            ...
            if (ka < ja || ka > aa.getViewportDimensions().y - ja)g.scrollTo(ia, true, false, ja);
        }
        ...
        if (this.props.feedback.isthreaded && ia.cancomment) {
            ...
            } else if (this.refs && this.refs['replycomposer-' + ja])this.refs['replycomposer-' + ja].focus();
        } else if (this.props.contextArgs.simplereply && ia.author && this.refs.toplevelcomposer && this.refs.toplevelcomposer.insertMention) {
            var ka = this.props.authorProfiles[ia.author].type, la = new m({uniqueID: ia.author, title: this.props.authorProfiles[ia.author].name, type: ka === 'friend' ? 'user' : ka});
        ...
        if (this.refs && this.refs.toplevelcomposer) {
            ...
            if (ia.getBoundingClientRect().top < ja)g.scrollTo(ia, true, true);
        }
    }});
    e.exports = ha;
}, null);
__d("ContextualBlind", ["Event", "Animation", "Arbiter", "DOM", "Rect", "Vector", "$", "shield"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    ...
    var x = {STYLE_LIGHT: 0, STYLE_DARK: 1, show: function (y, z, aa, ba, ca) {
        x.hide();
        ba = ba || t;
        ca = ca || x.STYLE_LIGHT;
        var da = (ca == x.STYLE_LIGHT) ? 'contextualBlind' : 'contextualBlind contextualBlindDark';
        for (var ea = 0; ea < 4; ea++)p.push(j.create('div', {className: da, style: 'opacity:' + ba}));
        ...
        if (z)ba = new k(ba.t - z, ba.r + z, ba.b + z, ba.l - z, ba.domain);
...
__d("ReactAbstractContextualDialog", ["ContextualDialog", "ContextualDialogArrow", "LayerAutoFocus", "LayerRefocusOnHide", "ReactPropTypes", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = {createSpec: function (n) {
        return {displayName: n.displayName, propTypes: {position: k.oneOf(['above', 'below', 'left', 'right']), alignment: k.oneOf(['left', 'center', 'right']), offsetX: k.number, offsetY: k.number, width: k.number, autoFocus: k.bool, focusContextOnHide: k.bool, arrowBehavior: k.func, behaviors: k.object, shown: k.bool, contextRef: k.string, hoverContext: k.object, hoverShowDelay: k.number, hoverHideDelay: k.number, hasActionableContext: k.bool}, immutableProps: {modal: null}, createLayer: function (o) {
            var p = this.props.context || this.getNodeForOwnerRef(this.props.contextRef), q = l({context: p, hoverContext: this.props.hoverContext, hoverShowDelay: this.props.hoverShowDelay, hoverHideDelay: this.props.hoverHideDelay, position: this.props.position, alignment: this.props.alignment, offsetX: this.props.offsetX, offsetY: this.props.offsetY, width: this.props.width, shouldSetARIAProperties: !this.props.hasActionableContext, arrowBehavior: this.props.arrowBehavior || h, addedBehaviors: this.enumerateBehaviors(this.props.behaviors)}, n || {}), r = new g(q, o);
            if (this.props.contextBounds)r.setContextWithBounds(p, this.props.contextBounds);
            if (this.props.autoFocus !== false)r.enableBehavior(i);
            if (this.props.focusContextOnHide === false)r.disableBehavior(j);
            ...
            if (p)if (o.contextBounds) {
                this.layer.setContextWithBounds(p, o.contextBounds);
            } else this.layer.setContext(p);
...
__d("ReactLayer", ["React", "ReactBrowserEventEmitter", "SubscriptionsHandler", "emptyFunction", "getObjectValues", "invariant", "merge"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    "use strict";
    var n = {componentDidMount: function () {
        ...
        g.renderComponent(g.createElement(g.DOM.div, null, this.props.children), this._layerContainer);
    }, render: function () {
        return null;
        ...
        for (s in q)if (!r[s])this.layer.disableBehavior(q[s]);
        for (s in r) {
            var t = q[s], u = r[s];
            if (t && u) {
                l(t === u);
        ...
        if (!this.getDefaultEnabledBehaviors)return p || {};
    ...
    }}, o = {createClass: function (p) {
        return g.createClass({mixins: [n, p]});
    }};
    e.exports = o;
}, null);
__d("XUIContextualDialogBody.react", ["React"], function (a, b, c, d, e, f, g) {
    var h = g.createClass({displayName: 'XUIContextualDialogBody', render: function () {
        return g.createElement(g.DOM.div, null, this.props.children);
    }});
    e.exports = h;
}, null);
__d("XUIOverlayFooter.react", ["React", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i) {
    var j = g.createClass({displayName: 'XUIOverlayFooter', render: function () {
        return (g.createElement(g.DOM.div, Object.assign({}, this.props, {className: i(this.props.className, "_5lnf uiOverlayFooter")}), this.props.children));
    }});
    e.exports = j;
}, null);
__d("XUIContextualDialogFooter.react", ["React", "XUIOverlayFooter.react", "cx"], function (a, b, c, d, e, f, g, h, i) {
    var j = g.createClass({displayName: 'XUIContextualDialogFooter', render: function () {
        return (g.createElement(h, {className: "_572u"}, this.props.children));
    }});
    e.exports = j;
}, null);
__d("XUIContextualDialogTitle.react", ["React", "cx"], function (a, b, c, d, e, f, g, h) {
    var i = g.createClass({displayName: 'XUIContextualDialogTitle', propTypes: {use: g.PropTypes.oneOf(['primary', 'secondary'])}, getDefaultProps: function () {
        return {use: 'primary'};
    }, render: function () {
        var j = this.props.use, k = (("_47lu") + (j === 'primary' ? ' ' + "_47lv" : '') + (j === 'secondary' ? ' ' + "_47mc" : ''));
        return (g.createElement(g.DOM.h3, {className: k}, this.props.children));
    }});
    e.exports = i;
}, null);
__d("XUIContextualDialog.react", ["HasLayerContextMixin", "ContextualDialogXUITheme", "React", "ReactAbstractContextualDialog", "ReactLayer", "XUIContextualDialogBody.react", "XUIContextualDialogFooter.react", "XUIContextualDialogTitle.react", "cx"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    var p = i.PropTypes, q = k.createClass(j.createSpec({displayName: 'ReactXUIContextualDialog', theme: h})), r = i.createClass({displayName: 'XUIContextualDialog', mixins: [g], propTypes: {position: p.oneOf(['above', 'below', 'left', 'right']), alignment: p.oneOf(['left', 'center', 'right']), offsetX: p.number, offsetY: p.number, width: p.number, autoFocus: p.bool, arrowBehavior: p.func, behaviors: p.object, shown: p.bool, context: p.object, contextRef: p.string, hoverContext: p.object, hoverShowDelay: p.number, hoverHideDelay: p.number, hasActionableContext: p.bool}, getDefaultProps: function () {
        return {hasActionableContext: false};
        ...
        if (t)s = i.createElement(i.DOM.div, {className: "_53iv"}, this._getDialogTitle(), t);
        return (i.createElement(q, Object.assign({}, this.props, {ref: "dialog", context: this.getContextNode()}), s, t ? this._getDialogFooter() : null));
    }});
    r.WIDTH = {NORMAL: 312, WIDE: 400};
    e.exports = r;
}, null);
__d("XUIText.react", ["React", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i) {
    var j = g.PropTypes, k = g.createClass({displayName: 'XUIText', propTypes: {size: j.oneOf(['small', 'medium', 'large', 'xlarge', 'inherit']), weight: j.oneOf(['bold', 'inherit', 'normal']), display: j.oneOf(['inline', 'block'])}, getDefaultProps: function () {
        return {size: 'inherit', weight: 'inherit', display: 'inline'};
    }, render: function () {
        ...
        if (this.props.display === 'block')return (g.createElement(g.DOM.div, Object.assign({}, this.props, {className: i(this.props.className, n)}), this.props.children));
        return (g.createElement(g.DOM.span, Object.assign({}, this.props, {className: i(this.props.className, n)}), this.props.children));
    }});
    e.exports = k;
}, null);
__d("XUIDialogBody.react", ["React", "cx", "joinClasses", "XUIText.react"], function (a, b, c, d, e, f, g, h, i, j) {
    var k = g.createClass({displayName: 'XUIDialogBody', propTypes: {useCustomPadding: g.PropTypes.bool}, render: function () {
        var l = (("_4-i2") + (!this.props.useCustomPadding ? ' ' + "_57_a" : ''));
        return (g.createElement(j, Object.assign({}, this.props, {className: i(this.props.className, l), display: "block", size: "medium"}), this.props.children));
    }});
    e.exports = k;
}, null);
__d("XUIDialogFooter.react", ["LeftRight.react", "React", "XUIOverlayFooter.react", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = h.PropTypes, m = h.createClass({displayName: 'XUIDialogFooter', propTypes: {leftContent: l.object}, render: function () {
        return (h.createElement(i, Object.assign({}, this.props, {className: k(this.props.className, "_5a8u")}), h.createElement(h.DOM.div, {className: "_50f4"}, h.createElement(g, null, h.createElement(h.DOM.div, null, this.props.leftContent), h.createElement(h.DOM.div, null, this.props.children)))));
    }});
    e.exports = m;
}, null);
__d("XUIButton.react", ["AbstractButton.react", "ReactPropTypes", "React", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = 'medium', m = i.createClass({displayName: 'XUIButton', statics: {getButtonSize: function (n) {
        return n.size || l;
    }}, propTypes: {use: h.oneOf(['default', 'special', 'confirm']), size: h.oneOf(['small', 'medium', 'large', 'xlarge', 'xxlarge']), borderShade: h.oneOf(['light', 'dark']), suppressed: h.bool}, getDefaultProps: function () {
        return {use: 'default', size: l, borderShade: 'light', suppressed: false};
    }, render: function () {
        ...
        return (i.createElement(g, Object.assign({}, this.props, {className: k(this.props.className, r)})));
    }});
    e.exports = m;
}, null);
__d("XUIDialogButton.react", ["ReactPropTypes", "React", "XUIButton.react", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k) {
    var l = h.createClass({displayName: 'XUIDialogButton', propTypes: {action: g.oneOf(['cancel', 'confirm', 'button'])}, render: function () {
        ...
        return (h.createElement(i, Object.assign({}, this.props, {className: k(this.props.className, n), href: o})));
    }});
    e.exports = l;
}, null);
__d("XUIDialogOkayButton.react", ["ReactPropTypes", "React", "XUIDialogButton.react", "cx", "tx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = h.createClass({displayName: 'XUIDialogOkayButton', propTypes: {action: g.oneOf(['confirm', 'cancel', 'button']).isRequired}, render: function () {
        return (h.createElement(i, Object.assign({}, this.props, {className: l(this.props.className, "_2z1w"), action: this.props.action, label: "\u041e\u041a"})));
    }});
    e.exports = m;
}, null);
__d("InlineBlock.react", ["React", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i) {
    var j = g.PropTypes, k = {baseline: null, bottom: "_6d", middle: "_6b", top: "_6e"}, l = g.createClass({displayName: 'InlineBlock', propTypes: {alignv: j.oneOf(['baseline', 'bottom', 'middle', 'top']), height: j.number, fullWidth: j.bool}, getDefaultProps: function () {
        return {alignv: 'baseline', fullWidth: false};
    }, render: function () {
        var m = k[this.props.alignv], n = "_6a";
        if (this.props.fullWidth)n = i(n, "_5u5j");
        var o = i(n, m);
        if (this.props.height != null) {
            var p = g.createElement(g.DOM.div, {className: i("_6a", m), style: {height: this.props.height + 'px'}});
            return (g.createElement(g.DOM.div, Object.assign({}, this.props, {className: i(this.props.className, n), height: null}), p, g.createElement(g.DOM.div, {className: o}, this.props.children)));
        } else return (g.createElement(g.DOM.div, Object.assign({}, this.props, {className: i(this.props.className, o)}), this.props.children));
    }});
    e.exports = l;
}, null);
...
__d("Popover", ["ContextualLayer", "ContextualLayerHideOnScroll", "DOM", "ParameterizedPopover"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    m.prototype._init = function () {
        "use strict";
        var n = new g({context: this._triggerElem, position: 'below', arrowDimensions: {offset: 12, length: 16}}, i.create('div'));
        n.enableBehaviors([h]);
...
__d("PopoverMenu", ["Arbiter", "ArbiterMixin", "ARIA", "BehaviorsMixin", "Event", "Focus", "Keys", "KeyStatus", "copyProperties", "mixin"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
    ...
    t.prototype._onMenuDone = function (u) {
        ...
        if (n.isKeyDown())l.set(this._triggerElem);
    };
    ...
    o(t.prototype, {_popoverShown: false});
    e.exports = t;
}, null);
__d("PopoverMenu.react", ["CSS", "InlineBlock.react", "Popover", "PopoverMenu", "React", "ReactPropTypes", "SubscriptionsHandler", "cx", "joinClasses", "areEqual"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
    var q = k.createClass({displayName: 'ReactPopoverMenu', statics: {getFirstChild: function (r) {
        var s = r.children;
        return Array.isArray(s) ? s[0] : s;
    }, getButtonSize: function (r) {
        var s = q.getFirstChild(r);
        return s && s.type.getButtonSize(s.props);
    }}, propTypes: {alignh: l.oneOf(['left', 'center', 'right']), alignv: l.oneOf(['baseline', 'bottom', 'middle', 'top']), position: l.oneOf(['above', 'below', 'left', 'right']), layerBehaviors: l.array, menu: l.object, disabled: l.bool, open: l.bool}, getDefaultProps: function () {
        return {alignv: 'middle'};
    }, _menuSubscriptions: null, componentDidMount: function () {
        var r = this.refs.root.getDOMNode(), s = r.firstChild;
        g.addClass(s, "_p");
        this._popover = new i(r, s, this.props.layerBehaviors, {alignh: this.props.alignh, position: this.props.position, disabled: this.props.disabled});
        ...
        if (!p(r.menu, this.props.menu)) {
            ...
            s && s.forEachItem(function (t) {
                return k.unmountComponentAtNode(t.getRoot().firstChild);
            });
            this._popoverMenu.setMenu(this._createMenu(this.props.menu));
        }
        if (this.props.alignh !== r.alignh)this._popoverMenu.getPopover().getLayer().setAlignment(this.props.alignh);
        if (this.props.disabled !== r.disabled)if (this.props.disabled) {
        ...
        return (k.createElement(h, Object.assign({}, this.props, {className: o(this.props.className, "uiPopover"), ref: "root", disabled: null}), this.props.children));
    }, componentWillUnmount: function () {
        if (this._menuSubscriptions) {
            this._menuSubscriptions.release();
            this._menuSubscriptions = null;
        ...
        if (s.onItemClick)this._menuSubscriptions.addSubscriptions(t.subscribe('itemclick', s.onItemClick));
        if (s.onItemFocus)this._menuSubscriptions.addSubscriptions(t.subscribe('focus', s.onItemFocus));
        if (s.onItemBlur)this._menuSubscriptions.addSubscriptions(t.subscribe('blur', s.onItemBlur));
        if (s.onChange)this._menuSubscriptions.addSubscriptions(t.subscribe('change', s.onChange));
...
__d("ReactSelectorUtils", ["ReactChildren"], function (a, b, c, d, e, f, g) {
    var h = {processAndMutateMenuItems: function (i, j) {
        var k;
...
__d("PopoverMenuContextMinWidth", ["CSS", "Style", "copyProperties", "cx", "shield"], function (a, b, c, d, e, f, g, h, i, j, k) {
    ...
    i(l.prototype, {_setMenuSubscription: null, _showSubscription: null, _menuSubscription: null});
    e.exports = l;
}, null);
__d("PopoverMenuOverlappingBorder", ["CSS", "DOM", "Style", "copyProperties", "cx", "shield"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    m.prototype._renderShortBorder = function (n) {
        "use strict";
        this._shortBorder = h.create('div', {className: "_54hx"});
    ...
    j(m.prototype, {_shortBorder: null, _setMenuSubscription: null, _showSubscription: null, _menuSubscription: null});
    e.exports = m;
}, null);
__d("AbstractSelector.react", ["InlineBlock.react", "React", "PopoverMenu.react", "ReactPropTypes", "ReactSelectorUtils", "ContextualLayerAutoFlip", "PopoverMenuContextMinWidth", "PopoverMenuOverlappingBorder", "cloneWithProps", "cx", "invariant", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
    var s = h.createClass({displayName: 'AbstractSelector', propTypes: {config: j.object.isRequired, alignh: j.oneOf(['left', 'center', 'right']), name: j.string, overlappingborder: j.bool, onChange: j.func, disabled: j.bool, maxheight: j.number}, getInitialState: function () {
        return {value: (this.props.value != null ? this.props.value : this.props.defaultValue != null ? this.props.defaultValue : this.props.initialValue)};
    }, setMenuValue: function (t) {
        q(this.refs && this.refs.popover);
        this._internalChange = true;
        this.refs.popover.getMenu().setValue(t);
        this._internalChange = false;
    }, onChange: function (t, u) {
        if (this._internalChange)return;
        if (this.props.value == null) {
            this.setState({value: u.value});
        } else this.setMenuValue(this.props.value);
        if (this.props.onChange)this.props.onChange(u);
    }, componentWillReceiveProps: function (t) {
        if (t.value != null)this.setState({value: t.value});
    }, render: function () {
        var t = this.props.config, u = o(t.menu, {children: this.props.children, className: r("_575t", t.menu.props.className), maxheight: this.props.maxheight, onChange: this.onChange}), v = k.processAndMutateMenuItems(this.props.children, this.state.value), w = {label: v.props.label || v.props.children, disabled: this.props.disabled};
        if (v.props.icon)w.image = o(v.props.icon, {});
        var x = o(t.button, w), y = [l];
        if (t.layerBehaviors)y = y.concat(t.layerBehaviors);
        var z = [m];
        if (this.props.overlappingborder)z.push(n);
        return (h.createElement(g, Object.assign({}, this.props, {alignv: "middle", name: null}), h.createElement(i, {ref: "popover", menu: u, alignh: this.props.alignh, layerBehaviors: y, behaviors: z, disabled: this.props.disabled}, x), h.createElement(h.DOM.input, {type: "hidden", name: this.props.name, value: this.state.value})));
    }, showMenu: function () {
        q(this.refs && this.refs.popover);
...
__d("ContextualLayerPositionClassOnContext", ["CSS", "copyProperties", "cx"], function (a, b, c, d, e, f, g, h, i) {
    ...
    h(j.prototype, {_subscription: null, _prevClassName: null});
    e.exports = j;
}, null);
__d("AbstractPopoverButton.react", ["ReactPropTypes", "React", "URI", "cloneWithProps", "cx", "joinClasses", "merge"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    var n = h.createClass({displayName: 'AbstractPopoverButton', propTypes: {config: g.object.isRequired, haschevron: g.bool, maxwidth: g.number}, getDefaultProps: function () {
        ...
        if (q) {
            ...
            if (this.props.label)r = {maxWidth: s + 'px'};
            p.style = m(p.style, {maxWidth: q + 'px'});
        }
        p.image = null;
        var t = null;
        if (this.props.image)t = j(this.props.image, {className: 'mrs'});
        if (t || this.props.label)p.label = h.createElement(h.DOM.span, {className: "_55pe", style: r}, t, this.props.label);
...
__d("XUIPopoverButton.react", ["AbstractPopoverButton.react", "Image.react", "React", "XUIButton.react", "cx", "ix", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    var n = i.PropTypes, o = i.createClass({displayName: 'ReactXUIPopoverButton', propTypes: {haschevron: n.bool, maxwidth: n.number}, statics: {getButtonSize: function (p) {
        return p.size || 'medium';
    }}, render: function () {
        var p = o.getButtonSize(this.props), q = "_55pi";
        if (this.props.theme === 'dark')q = m(q, (("_5vto") + (p === 'small' ? ' ' + "_55_o" : '') + (p === 'medium' ? ' ' + "_55_p" : '') + (p === 'large' ? ' ' + "_55_q" : '') + (p === 'xlarge' ? ' ' + "_55_r" : '') + (p === 'xxlarge' ? ' ' + "_55_s" : '')));
        ...
        if (!r) {
            ...
            r = i.createElement(h, {src: s});
        }
        var t = {button: i.createElement(j, Object.assign({}, this.props, {className: m(this.props.className, q), size: p})), chevron: r, chevronWidth: 14, defaultMaxWidth: this.props.maxwidth || 200};
        return (i.createElement(g, {config: t, haschevron: this.props.haschevron, image: this.props.image, label: this.props.label, maxwidth: this.props.maxwidth}));
    }});
    e.exports = o;
}, null);
__d("PopoverMenuInterface", ["ArbiterMixin", "copyProperties", "emptyFunction", "mixin"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    h(n.prototype, {getRoot: i, onShow: i, onHide: i, focusAnItem: i.thatReturnsFalse, blur: i, handleKeydown: i.thatReturnsFalse});
    e.exports = n;
}, null);
__d("ScrollableArea", ["Animation", "ArbiterMixin", "BrowserSupport", "CSS", "DataStore", "DOM", "Event", "Parent", "Run", "SimpleDrag", "Style", "UserAgent_DEPRECATED", "Vector", "throttle", "mixin"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
    ...
    z.prototype.scrollElemToTop = function (aa, ba, ca) {
        "use strict";
        this.setScrollTop(aa.offsetTop, ba, {callback: ca});
    };
    ...
    z.renderDOM = function () {
        "use strict";
        var aa = l.create('div', {className: 'uiScrollableAreaContent'}), ba = l.create('div', {className: 'uiScrollableAreaBody'}, aa), ca = l.create('div', {className: 'uiScrollableAreaWrap scrollable'}, ba), da = l.create('div', {className: 'uiScrollableArea native'}, ca);
        return {root: da, wrap: ca, body: ba, content: aa};
    };
    z.fromNative = function (aa, ba) {
        ...
        var ca = l.create('div', {className: 'uiScrollableAreaTrack'}, l.create('div', {className: 'uiScrollableAreaGripper'}));
        if (ba.fade !== false) {
            j.addClass(aa, 'fade');
...
__d("Menu", ["BehaviorsMixin", "CSS", "DataStore", "DOM", "Event", "Keys", "KeyStatus", "Parent", "PopoverMenuInterface", "ScrollableArea", "Style", "copyProperties", "cx"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
    ...
    v.prototype.onShow = function () {
        ...
        if (this._config.maxheight)if (!this._scrollableArea) {
            this._scrollableArea = p.fromNative(this._scrollableElems.root, {fade: true});
    ...
    v.prototype._render = function () {
        "use strict";
        this._ul = j.create('ul', {className: "_54nf"});
        ...
        this._root = j.create('div', {className: x}, j.create('div', {className: "_54ng"}, w));
    ...
    v.prototype._handleItemClick = function (w, x) {
        "use strict";
        this.inform('itemclick', {item: w, event: x});
    ...
    v.prototype._focusItem = function (w, x) {
        ...
        if (w.focus(x) !== false) {
            if (this._focused !== w) {
                this.blur();
                this._focused = w;
                this.inform('focus', {item: w, from_mouse_over: x});
            }
            return true;
        }
        return false;
    ...
    r(v.prototype, g, {_focused: null, _root: null});
    e.exports = v;
}, null);
__d("MenuItemInterface", ["copyProperties", "emptyFunction"], function (a, b, c, d, e, f, g, h) {
    ...
    g(i.prototype, {_root: null, render: h, getAccessKey: h, hasAction: h.thatReturnsFalse, focus: h.thatReturnsFalse, blur: h.thatReturnsFalse, onShow: h.thatReturnsFalse, handleClick: h.thatReturnsFalse, destruct: h});
    e.exports = i;
}, null);
__d("MenuItemBase", ["DOM", "HTML", "MenuItemInterface", "cx", "mergeInto"], function (a, b, c, d, e, f, g, h, i, j, k) {
    ...
    n.prototype.render = function () {
        "use strict";
        var o = "_54ni";
        if (this._data.className)o += ' ' + this._data.className;
        var p = {className: o, role: 'presentation'};
    ...
    n.prototype.__getAttributesFromData = function () {
        "use strict";
        var o = {};
        for (var p in this._data)if (p.indexOf('data-') === 0 || p.indexOf('aria-') === 0)o[p] = this._data[p];
        return o;
    };
    e.exports = n;
}, null);
__d("MenuItem", ["CSS", "DOM", "MenuItemBase", "React", "cloneWithProps", "copyProperties", "cx", "emptyFunction"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    ...
    t.prototype.handleClick = function () {
        ...
        if (typeof this._onclickHandler === 'function')return this._onclickHandler();
        return true;
    };
    ...
    t.prototype._renderItemContent = function () {
        "use strict";
        this._anchor = h.create('a', {className: (("_54nc") + (this._data.icon ? ' ' + "_54nu" : ''))});
        if (this._data.children) {
            var u = null;
            if (this._data.icon)u = k(this._data.icon, {className: 'mrs'});
            j.renderComponent(j.createElement(j.DOM.span, null, u, j.createElement(j.DOM.span, {className: "_54nh"}, this._data.children)), this._anchor);
            this._data.label = this._anchor.innerText || this._anchor.textContent;
        } else {
            var v = h.create('span', null, h.create('span', {className: "_54nh"}, this._data.markup || this._data.label));
    ...
    l(t.prototype, {hasAction: n.thatReturnsTrue});
    e.exports = t;
}, null);
...
__d("SelectableMenuUtils", [], function (a, b, c, d, e, f) {
    var g = {doesItemSupportSelect: function (i) {
        return h(i);
...
__d("SelectableMenu", ["Menu", "arrayContains", "createArrayFrom", "SelectableMenuUtils"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    m.prototype._handleItemClick = function (n, o) {
        ...
        var p = this.inform('itemclick', {item: n, event: o});
        if (p)return;
    ...
    m.prototype.getSelection = function () {
        ...
        this._items.forEach(function (o) {
            if (j.isSelected(o))n.push({label: o.getLabel(), value: o.getValue(), item: o});
        });
...
__d("ReactMenu", ["Menu", "MenuItem", "MenuSelectableItem", "MenuTheme", "ReactChildren", "SelectableMenu", "cx", "joinClasses"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    ...
    function s(w, x) {
        "use strict";
        var y = Object.assign({theme: j, maxheight: w ? w.maxheight : null, className: w ? w.className : null}, x);
    ...
    function v(w, x) {
        "use strict";
        var y = Object.assign({className: n("_57di", w ? w.className : null), theme: j, multiple: w && w.multiple, maxheight: w ? w.maxheight : null}, x);
...
__d("XUISelector.react", ["AbstractSelector.react", "ContextualLayerPositionClassOnContext", "React", "XUIPopoverButton.react", "ReactXUIMenu", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    var m = k.SelectableMenu, n = k.SelectableItem, o = i.createClass({displayName: 'ReactXUISelector', statics: {getButtonSize: function (p) {
        return p.size || 'medium';
    }}, getDefaultProps: function () {
        return {haschevron: true};
    }, render: function () {
        var p = {button: i.createElement(j, {haschevron: this.props.haschevron, disabled: this.props.disabled, use: this.props.use, size: this.props.size, suppressed: this.props.suppressed, theme: "dark", maxwidth: this.props.maxwidth}), menu: i.createElement(m, {maxheight: this.props.maxheight}), layerBehaviors: [h]};
        return (i.createElement(g, Object.assign({}, this.props, {ref: "abstractSelector", config: p}), this.props.children));
    }, showMenu: function () {
...
__d("XUFIActorSelectorNuxSeenControllerURIBuilder", ["XControllerURIBuilder"], function (a, b, c, d, e, f) {
    e.exports = b("XControllerURIBuilder").create("\/ufi\/actor_selector\/nux\/seen\/", {is_covered: {type: "Bool"}, is_timeline: {type: "Bool"}});
}, null);
__d("UFIActorSelector.react", ["ActorSelector.react", "Arbiter", "AsyncRequest", "Parent", "React", "SubscriptionsHandler", "UFICentralUpdates", "UFIFeedbackTargets", "UFIUserActions", "XUFIActorSelectorNuxSeenControllerURIBuilder", "fbt"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
    var r = 'ufi_actor_selector_nux_disabled_event', s = k.createClass({displayName: 'UFIActorSelector', propTypes: {actorIDs: k.PropTypes.array.isRequired, ftEntIdentifier: k.PropTypes.string.isRequired, isTimeline: k.PropTypes.bool, nuxEnabledCovered: k.PropTypes.bool, nuxEnabledUncovered: k.PropTypes.bool, nuxHoverContext: k.PropTypes.object, settingsURI: k.PropTypes.string}, getInitialState: function () {
        var t = j.byClass(this.props.nuxHoverContext, 'timelineUnitContainer');
        return {loading: false, nuxEnabledCovered: this.props.nuxEnabledCovered, nuxEnabledUncovered: this.props.nuxEnabledUncovered, nuxHoverContext: t ? t : this.props.nuxHoverContext, selectedActorID: null};
    }, render: function () {
        return (k.createElement(g, {actorIDs: this.props.actorIDs, coverEnabled: true, loading: this.state.loading, nuxBody: this._getNUXBody(), nuxEnabledCovered: this.state.nuxEnabledCovered, nuxEnabledUncovered: this.state.nuxEnabledUncovered, nuxHoverContext: this.state.nuxHoverContext, onChange: this._onChange, onCompleteNux: this._onCompleteNux, selectedActorID: this.state.selectedActorID, settingsURI: this.props.settingsURI, tooltipConstructor: this._getTooltipForActorName, tooltipConstructorCovered: this._getCoveredTooltip}));
    }, componentDidMount: function () {
        ...
        this._subscriptions.addSubscriptions(m.subscribe('feedback-updated', function (t, u) {
            if (this.props.ftEntIdentifier in u.updates)this._updateSelectedActorIDFromFeedbackTarget();
        }.bind(this)), h.subscribe(r, function () {
            this.setState({nuxEnabledCovered: false, nuxEnabledUncovered: false});
        }.bind(this)));
    }, componentWillUnmount: function () {
        ...
        n.getFeedbackTarget(this.props.ftEntIdentifier, function (t) {
            this.setState({loading: false, selectedActorID: t.actorforpost});
        }.bind(this));
    }, _getNUXBody: function () {
        return ("\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435, \u043e\u0442\u043c\u0435\u0447\u0430\u0442\u044c \u043a\u0430\u043a \u043f\u043e\u043d\u0440\u0430\u0432\u0438\u0432\u0448\u0435\u0435\u0441\u044f \u0438 \u043a\u043e\u043c\u043c\u0435\u043d\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c \u043e\u0442 \u0441\u0432\u043e\u0435\u0433\u043e \u0438\u043c\u0435\u043d\u0438 \u0438\u043b\u0438 \u043e\u0442 \u0438\u043c\u0435\u043d\u0438 \u0421\u0442\u0440\u0430\u043d\u0438\u0446, \u043a\u043e\u0442\u043e\u0440\u044b\u043c\u0438 \u0432\u044b \u0443\u043f\u0440\u0430\u0432\u043b\u044f\u0435\u0442\u0435.");
    }, _getTooltipForActorName: function (t) {
        return (q._("\u041e\u0442\u043c\u0435\u0447\u0430\u0435\u0442\u0435 \u043a\u0430\u043a \u043f\u043e\u043d\u0440\u0430\u0432\u0438\u0432\u0448\u0435\u0435\u0441\u044f \u0438 \u043a\u043e\u043c\u043c\u0435\u043d\u0442\u0438\u0440\u0443\u0435\u0442\u0435 \u043e\u0442 \u0438\u043c\u0435\u043d\u0438 {actorName}", [q.param("actorName", t)]));
...
__d("UnicodeCJK", [], function (a, b, c, d, e, f) {
    ...
    function ha(ja) {
        if (ga(ja))return ja.substr(0, ja.length - 1);
        return ja;
    }

    var ia = {hasKana: ba, hasIdeograph: ca, hasIdeoOrSyll: da, hiraganaToKatakana: fa, isKanaWithTrailingLatin: ga, kanaRemoveTrailingLatin: ha};
    e.exports = ia;
}, null);
__d("UnicodeHangulKorean", [], function (a, b, c, d, e, f) {
    ...
    var z = {toConjoiningJamo: y};
    e.exports = z;
}, null);
__d("FeedBlacklistButton", ["Arbiter", "Event"], function (a, b, c, d, e, f, g, h) {
    var i = {BLACKLIST: 'feed_blacklist', UNBLACKLIST: 'feed_unblacklist', init: function (j, k, l, m) {
...
__d("XPubcontentChainedSuggestionsControllerURIBuilder", ["XControllerURIBuilder"], function (a, b, c, d, e, f) {
    e.exports = b("XControllerURIBuilder").create("\/pubcontent\/chained_suggestions\/", {pageid: {type: "String"}, profileid: {type: "Int"}, eh: {type: "Bool"}, friendid: {type: "Int"}});
}, null);
__d("SubscribeButton", ["Arbiter", "AsyncRequest", "Button", "CSS", "Event", "Tooltip", "XPubcontentChainedSuggestionsControllerURIBuilder"], function (a, b, c, d, e, f, g, h, i, j, k, l, m) {
    var n = {SUBSCRIBED: 'FollowingUser', UNSUBSCRIBED: 'UnfollowingUser', _enable: function (o) {
        i.setEnabled(o, true);
        l.remove(o);
        ...
        if (x && !u && !v)n._disable(p, w);
        k.listen(p, 'click', function () {
            g.inform(n.SUBSCRIBED, {profile_id: r, suppress: true});
        });
        g.subscribe(n.SUBSCRIBED, function (y, z) {
            if (r == z.profile_id) {
                if (!s)q.suppressNextMouseEnter && q.suppressNextMouseEnter();
                if (x) {
                    if (typeof z.connected !== 'undefined')u = z.connected;
                    if (u || v)n._enable(p);
                }
                o.swap();
                if (t === true) {
        ...
        k.listen(o, 'click', function () {
            setTimeout(g.inform.bind(g, n.SUBSCRIBED, {profile_id: p}), 0);
        });
    }, initUnsubscribe: function (o, p) {
        k.listen(o, 'click', function () {
            setTimeout(g.inform.bind(g, n.UNSUBSCRIBED, {profile_id: p}), 0);
        });
...
__d("DataSource", ["ArbiterMixin", "AsyncRequest", "TokenizeUtil", "UnicodeMatch", "copyProperties", "createArrayFrom", "createObjectFrom", "emptyFunction", "mixin"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    ...
    function s(t) {
        ...
        this.backendUnicodeMatch = new j({prefix_kana_hiragana_to_katakana: !!t.kanaNormalization});
        this.cacheUnicodeMatch = new j({prefix_kana_hiragana_to_katakana: !!t.kanaNormalization});
    }
    ...
    s.prototype.bootstrapWithToken = function () {
        ...
        t.token = this.token;
        this.fetch(this.bootstrapEndpoint, t, {bootstrap: true, replaceCache: true, value: ''});
    };
    s.prototype.query = function (t, u, v, w) {
        "use strict";
        this.inform('beforeQuery', {value: t, local_only: u, exclusions: v, time_waited: w});
        ...
        this.value = t;
        this.inform('query', {value: t, results: y});
        ...
        this.inform('queryEndpoint', {value: t});
        this.fetch(this.queryEndpoint, this.getQueryData(t, x), {value: t, exclusions: v});
        return true;
    };
    ...
    s.prototype.getQueryData = function (t, u) {
        "use strict";
        var v = k({value: t}, this.queryData || {});
        u = u || [];
    ...
    s.prototype.notify = function (t, u, v, w) {
        ...
        this.inform('notify', {value: t, results: x, isAsync: !!v, rootid: w});
        return x;
    };
    s.prototype.respond = function (t, u, v) {
        "use strict";
        var w = this.buildData(u);
        this.inform('respond', {value: t, results: w, isAsync: !!v});
        return w;
    };
    s.prototype.respondWithResults = function (t, u, v) {
        "use strict";
        this.inform('respond', {value: t, results: u, isAsync: !!v});
        return u;
    };
    s.prototype.fetch = function (t, u, v) {
        "use strict";
        if (!t)return;
        if (u.request_id === undefined) {
        ...
        this.inform('beforeFetch', {request: w, fetch_context: v});
        w.send();
    ...
    s.prototype.fetchHandler = function (t, u) {
        ...
        this.addEntries(z, v);
        this.inform('fetchComplete', {entries: z, response: t, value: v, fetch_context: u});
    ...
    s.prototype.mergeUids = function (t, u, v, w) {
        "use strict";
        this.inform('mergeUids', {local_uids: t, query_uids: u, new_uids: v, value: w});
        var x = function (y, z) {
    ...
    s.prototype.findBestPreviousQuery = function (t) {
        "use strict";
        var u = 0, v = null, w = this.getQueryCache();
        if (this._queryExactMatch)return w.hasOwnProperty(t) ? t : null;
    ...
    s.prototype.findQueryCache = function (t) {
        "use strict";
        var u = this.findBestPreviousQuery(t);
    ...
    s.prototype.buildCacheResults = function (t, u) {
        ...
        for (var ga = 0; ga < x; ++ga) {
            ...
            for (var ia in u)if ((!z.hasOwnProperty(ia) && ia === ha) || ((this._alwaysPrefixMatch || y === ga) && this.cacheUnicodeMatch.prefixMatch(ia, ha))) {
                if (ia === ha) {
    ...
    k(s.prototype, {events: ['bootstrap', 'query', 'respond'], asyncErrorHandler: n});
    e.exports = s;
}, null);
__d("DialogHideOnSuccess", ["CSS", "copyProperties", "cx"], function (a, b, c, d, e, f, g, h, i) {
    ...
    h(j.prototype, {_subscription: null});
    e.exports = j;
}, null);
__d("MultiBootstrapDataSource", ["DataSource"], function (a, b, c, d, e, f, g) {
    ...
    j.prototype.bootstrapWithoutToken = function () {
        "use strict";
        for (var k = 0; k < this._bootstrapEndpoints.length; k++)this.fetch(this._bootstrapEndpoints[k].endpoint, this._bootstrapEndpoints[k].data || {}, {bootstrap: true});
    };
    e.exports = j;
}, null);
__d("ReactRenderer", ["React", "Run", "$"], function (a, b, c, d, e, f, g, h, i) {
    ...
    e.exports = {constructAndRenderComponent: j, constructAndRenderComponentByID: l, constructAndRenderComponentAcrossTransitions: k, constructAndRenderComponentByIDAcrossTransitions: m};
}, null);
__d("Tour", ["Arbiter", "LayerDestroyOnHide", "LayerHideOnEscape", "NavigationMessage", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k) {
    function l() {
        "use strict";
        if (l._instance)l._instance.setTourComplete();
        l._instance = this;
    }
    ...
    l.prototype.showStep = function (m) {
        "use strict";
        var n = this.steps[m];
        if (!(this.openDialog == n))this.hideOpenDialog();
        if (!n)return;
        this.openDialog = n;
        n.show();
    };
    ...
    k(l.prototype, {tourStarted: false, tourComplete: false, _navigationBeginToken: null, _pageLeaveToken: null, steps: {}, openDialog: null});
    e.exports = l;
}, null);
...
__d("PageFanning", ["Animation", "AsyncRequest", "CSS", "DOM", "Parent", "URI", "$", "collectDataAttributes", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    var p = {setFanStatus: function (r, s, t, u, v, w, x) {
        var y = {ft: {}};
        if (r)y = {ft: n(r, ['ft']).ft};
        v = v || function (ba) {
    ...
    function q(r, s) {
        var t = s.feedback;
        if (!t)return;
        if (k.byClass(r, 'fbTimelineEscapeSectionItem'))r = k.byClass(r, 'fan_status_inactive') || r;
        var u = j.create('span', {className: 'fan_status_inactive'}, t);
        r.parentNode.replaceChild(u, r);
        var v = function () {
            if (s.can_repeat_action)u.parentNode.replaceChild(r, u);
        };
...
__d("XPagesLikeCountControllerURIBuilder", ["XControllerURIBuilder"], function (a, b, c, d, e, f) {
    e.exports = b("XControllerURIBuilder").create("\/pages\/x\/updateLikeCountDomString\/", {page_id: {type: "Int", required: true}, like_id: {type: "String", required: true}});
}, null);
__d("PageLikeButton", ["Arbiter", "AsyncRequest", "AsyncResponse", "Event", "PageFanning", "SubscribeButton", "FeedBlacklistButton", "Tour", "URI", "XPagesLikeCountControllerURIBuilder"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
    var q = {LIKED: 'liked', UNLIKED: 'unliked', LIKED_SUCCESS: 'liked_success', SPM_CALLOUT: 'spm_callout', init: function (t, u, v, w, x, y, z, aa, ba, ca, da) {
        g.subscribe(q.LIKED, function (ea, fa) {
            if (w === fa.profile_id) {
                t.swap();
                if (!ba)v.suppressNextMouseEnter && v.suppressNextMouseEnter();
            }
        });
        ...
        if (da)g.subscribe(q.SPM_CALLOUT, function (ea, fa) {
            if (w === fa.profile_id) {
                da.show();
                g._releaseAllEvents(q.SPM_CALLOUT);
            }
        });
        if (aa)g.subscribe(q.LIKED_SUCCESS, function (ea, fa) {
            var ga = o.getRequestURI().getQueryData().app_data;
            if (fa.profile_id === w)new h().setURI('/ajax/pages/fetch_app_column.php').setData({profile_id: w, tab_key: aa, app_data: ga}).send();
        });
        ...
        j.listen(t, 'click', function (event) {
            r(event.getTarget(), u, false, function (w) {
                g.inform(q.LIKED, {profile_id: u});
                i.defaultErrorHandler(w);
            }, v);
            q.informUnlike(u);
        });
    }, informLike: function (t, u, v) {
        var w = {profile_id: t, target: u, origin: v};
        g.inform(q.LIKED, w);
        w.connected = true;
    ...
    function r(t, u, v, w, x, y, z) {
        ...
        }, w, {fan_origin: x, fan_source: y, cat: z});
    }

    function s(t, u, v, w, x, event) {
        r(event.getTarget(), t, true, function (y) {
            g.inform(q.UNLIKED, {profile_id: t});
...
__d("SwapButton", ["DOM", "Event", "Focus", "copyProperties"], function (a, b, c, d, e, f, g, h, i, j) {
    ...
    function l(m, n, o) {
        ...
        if (o)h.listen(n, 'click', k.bind(null, m, n, true));
    }
    ...
    j(l.prototype, {_swapperButton: null, _swappeeButton: null});
    e.exports = l;
}, null);
__d("HoverButton", ["AsyncRequest", "CSS", "DOM", "URI", "copyProperties", "cx"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
    ...
    m.prototype._onShow = function (n, o) {
        "use strict";
        h.addClass(o, "_52nd");
        if (h.hasClass(o, 'uiButton') || h.hasClass(o, "_42fu"))h.addClass(o, 'selected');
    ...
    m.prototype._onHide = function (n, o) {
        ...
        if (h.hasClass(o, 'uiButton') || h.hasClass(o, "_42fu"))h.removeClass(o, 'selected');
    };
    ...
    k(m.prototype, {_button: null, _flyout: null, _flyoutAjaxify: null, _flyoutContent: null});
    e.exports = m;
}, null);
__d("HoverFlyout", ["Arbiter", "ArbiterMixin", "DataStore", "Event", "Keys", "arrayContains", "mixin", "removeFromArray", "shield"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
    ...
    s.prototype.initNode = function (t) {
        "use strict";
        if (l(this._nodes, t))return this;
        this._nodes.push(t);
    ...
    s.prototype.deactivateNode = function (t) {
        ...
        if (u)while (u.length)u.pop().remove();
        n(this._nodes, t);
    };
